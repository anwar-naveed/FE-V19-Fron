...
export class CustomViewportScroller implements ViewportScroller {
    ...
    scrollToPosition(position: [number, number]): void {
        ...
        if (this.supportScrollRestoration() && scrollEl) {
            ...
            setTimeout(() => {
                ...
                scrollEl.scrollTo({left: position[0], top: position[1], behavior: 'smooth'});
                // scrollEl.scroll({ top: 0, left: 0, behavior: 'smooth' });
            }, 100);
        }
    }
    ...
    private scrollToElement(el: any): void {
        ...
        this.window.scroll({ top: offset[1], left: offset[0], behavior: 'smooth' });
    }
